...
public interface ActivityRepository extends JpaRepository<Activity, Long> {
    ...
    /** Ordered so startup seed can pick one row and drop accidental duplicates. */
    List<Activity> findAllByNameIgnoreCaseAndDestinationIdOrderByIdAsc(String name, Long destinationId);
}
